-- 107: v_screener universe widened to CURRENT SOURCE MEMBERS (9/20).
-- PRN/PTF lesson: MFR served them daily, but the view universe was
-- ticker_tags+held only, so ETF Pro shorts and live shelf names were
-- invisible to every screen and the shelf printed rp=None.
