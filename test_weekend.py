...
check("gics wins", _coarse_sector("Energy", "whatever", None), "Energy")
check("precious metals -> Commodities", _coarse_sector(None, "Precious Metals", None), "Commodities")
check("bond fund -> Fixed Income", _coarse_sector(None, "Ultrashort Bond", None), "Fixed Income")
check("single currency -> Currency", _coarse_sector(None, "Single Currency", None), "Currency")
check("digital assets -> Crypto", _coarse_sector(None, "Digital Assets", None), "Crypto")
check("unknown non-gics -> ETF/Thematic", _coarse_sector(None, "Mid-Cap Value", None), "ETF/Thematic")
